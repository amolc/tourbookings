			...
			<div class="panel-body">
				...
				<?php 
					if($_POST['submit'] == 'submit')
					{
						...
						$booking_query = "insert into Supplier_Booking 
						(tour_id,partner_supplier_id,supplier_id,currency_id,amount,traveller_id,status,start_date,end_date,insert_date) 
						 values 
						('$tour_id','$supplier_id','$supplier_id','$currency','$booking_ammount','$traveller_id','$status','$start_date','$end_date','$current_date')";
						...
						foreach ($adults as $adult){
							$traveller_query = "insert into traveler (user_id,supplier_id,tour_id,booking_id,first_name,last_name,adult_child_status,sex,age,proof_id)
							values 
							('$user_id','$supplier_id','$tour_id','$booking_id','$adult','$last_name','adult','$sex','$age','$proof_id')";
						...
						foreach ($childs as $child){
							$traveller_query1 = "insert into traveler (user_id,supplier_id,tour_id,booking_id,first_name,last_name,adult_child_status,sex,age,proof_id)
							values 
						...
						$balance_query = mysql_query("SELECT
									...
									");
			            $balance_result = mysql_fetch_array($balance_query);			
