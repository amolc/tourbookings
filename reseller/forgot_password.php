...
<?php //include('include/header/header.php'); ?>
			...
			<?php
				...
				{
					$email = $_POST['email'];
					$sql = mysql_query("select password , email from supplier where email = '".$email."'");
			...
			// echo $row['email'];
					...
					echo $mail_sent ? " <div><h2>Your Tour Detail Sent To Your Inbox</h2></div>" : "Mail failed";
					}
					else
					{
						echo "<div><h2>Your Email Is Wrong!</h2></div>";
					} 
