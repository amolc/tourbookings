...
<div style="float: right;margin-right: 40px;">
	<div style="font-size: 20px;padding-bottom: 10px;">
		<span style="padding-right: 14px;">Total:</span><span style="font-size: 25px;">$</span><span class="total_payment"  style="font-size: 25px;"><?php echo $sum; ?></span>
	</div>
	<div style="font-size: 20px;display:none;">
		<input type="button" class="transfer_account btn btn-default" value="Deposit Payment >>"/>
	</div>
</div>
<br />
<br />
