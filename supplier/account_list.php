	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$('.delete_account').click(function(){
				...
				$.ajax({
						type: 'post',
						url: 'ajax_request_function/ajax_delete_account.php',
...
<h2> Account</h2>
	...
	<div style="font-size: 20px;width: 100%;margin-bottom: 10px;height: 20px;">
		<a href="supplier_bank_account.php">
			<input type="button" style="float: right;" class="btn btn-default" value="Add Account >>"/>
		</a>
	</div>
...
<table class="table table-bordered datatable" id="table-1">
	...
	<?php
			$result = mysql_query("SELECT
									*
									...
									WHERE supplier_bank_account.supplier_id = '".$supplier_id."'
									GROUP BY supplier_bank_account.id
									ORDER BY supplier_bank_account.id DESC
									");
	...
	echo'
		<tr class="odd gradeX">
			...
			<td>'.$row['address'].'</td>
			<td>
				<a href="edit_account.php?account_id='.$row['id'].'" class="edit_account">
				 <i class="entypo-pencil"></i>
				 
				</a>
			   </td>
			   <td>    
				<a id="'.$row['id'].'" class="delete_account">
