		...
		?>			
					<div class=" voucher">
                        ...
                        <div class="voucher_heading">
                        	<h1>Tour Confirmation Voucher</h1>
                        </div>
                      </div>
                      
                      <div class="tour_title">
                        	<p><strong>Tour Title:</strong><?php echo $row['title'];?>
                            <span>Booking Date: <?php echo $row['start_date'];?></span>
                            <span>Adult Name: <?php echo $adult_row['first_name'];?></span>
                            </p>
                            
                            <p>Please hand this voucher to our representative at the start of your tour.
								our representative will meet you in the immigration hall of airport, holding an <b>Example Tour</b>signboard<br>
<br>
