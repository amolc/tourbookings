...
<?php include('include/header/header.php'); ?>
			...
			<ol class="breadcrumb bc-3">
				...
				<li class="active">
					<strong>Credit Card/Paypal Deposit</strong>
				</li>
			</ol>

			<h2>Credit Card/Paypal Deposit</h2>
			<br />
	...
	<div class="col-md-12">
		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
				...
				<form   method="post" role="form" id="form1"   novalidate="novalidate" class="form-horizontal validate" enctype="multipart/form-data" action='../rest-api-sdk-php-master/sample/payments/deposit_payment.php'>
					
						<div class="form-group">
							<label for="field-1" class="col-sm-3 control-label">Amount (USD)</label> 
						...
						<div class="form-group">
							...
							<div style="float:left;" class="col-sm-5">
								<input type="text" data-validate=""  style="width:43%;" class="form-control" name="exp_date" id="title011" placeholder="" required>
								
							</div>
							<div style="float:left;display:none;" class="col-sm-5">
								
								<input type="text" data-validate="number"  style="width:15%;" class="form-control" name="exp_year" id="title022" placeholder="" required>
							</div>
						</div>
						<div class="form-group"> 
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="text" data-validate=""  style="width:43%;" class="form-control" name="first_name" id="title1" placeholder="" required>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="text" data-validate=""  style="width:43%;" class="form-control" name="last_name" id="title2" placeholder="" required>
							</div>
						</div>
