...
$query = mysql_query("SELECT *
						FROM supplier_bank_account	where id = '".$account_id."' and supplier_id ='".$supplier_id."'");
...
<input type="hidden" name="account_id" value="<?php echo $account_id ; ?>"/>
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="text" data-validate="required"   class="form-control" name="account_name" value="<?php echo $account_name;?>" id="title" placeholder="" required>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="text" data-validate="number"   class="form-control" name="account_number" value="<?php echo $account_number;?>"  id="title" placeholder="" required>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="text" data-validate="required"   class="form-control" name="account_type" value="<?php echo $account_type;?>"  id="title" placeholder="" required>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="text" data-validate="required"   class="form-control" name="bank_name" value="<?php echo $bank_name;?>"  id="title" placeholder="" required>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="text" data-validate="required"   class="form-control" name="address" value="<?php echo $address;?>" id="title" placeholder="" required>
							</div>
						</div>
