...
// echo "<br>$old_pass ";exit;
 ...
 {
 header("Location:changepassword.php?wrong=ok");
 }
...
echo '<h2 style="color:red;">Old password doesnot match </h2>';
} 
			...
			<div class="panel-body">
				...
				<form   method="post" role="form" id="form1"   novalidate="novalidate" class="form-horizontal validate" enctype="multipart/form-data" action=''>
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="password" style="width:45%" class="form-control" id="old_pass" name="old_pass" placeholder="Old Password">
							</div>
							<div class="old_error" style="color:red;"></div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="password" style="width:45%" class="form-control" id="new_pass" placeholder="New Password">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="password" style="width:45%" class="form-control" name="pass" id="con_pass" placeholder="Confirm Password">
							</div>
							<div class="error_mesg" style="color:red;"></div>
						</div>
						
						<div class="form-group">
                                  <label for="field-1" class="col-sm-3 control-label">Show Password:</label>
