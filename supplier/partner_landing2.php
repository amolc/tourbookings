							...
							<div style="height: auto;" class="right_colm fr">
							  <div class="partner_form fl">
								...
								<?php
									...
									// {
										// echo "<div style='font-weight: bold;color: #F00;line-height: 20px;text-align: left;margin-bottom: 20px;'>Thank you for registering with Tourbookings.</div>";
						...
						$language = mysql_real_escape_string($_POST['language']);
							 $sql   = "insert into supplier(first_name,last_name,phone,email,password,company_name,
							   ...
							   $query = mysql_query($sql);
                                // if ($query)
                                // {
									// header("Location:partner_landing2.php?sent=ok");
								...
								if($query)
								{
									...
									$headers2 .= "From: " . $email . ">\r\n";
									// $headers2 .= 'Cc: support@tourbookings.co' . "\r\n";
									...
									// {
										// header('Location:partner_landing2.php?sent=ok');
									// }
									echo "<h3 style='margin-bottom: 20px;'><span style='font-size: 17px; '>Thank you for joining our Travel Partner Program. <a href='http://tourbookings.co/supplier' style='font-size:20px;'> Click here</a> to proceed to the login page. </span> </h3>";
