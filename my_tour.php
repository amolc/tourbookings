...
$query1 = mysql_query("SELECT
						...
						INNER JOIN tour_photo ON tour.id = tour_photo.tour_id
						INNER JOIN booking ON tour.id = booking.tour_id
						WHERE tour.status = 'accepted'  AND booking.user_id = '".$user_id."'    GROUP BY tour.title");
											...
											$string = strip_tags($record['title']);
												...
												echo '<div class="tour_picks fl">
												  ...
												  echo'<span>USD $'.$price_customer_adult.'</span>
													...
													<a href="my_tour_detail.php?tour_id='.$record['id'].'&booking_id='.$record['booking_id'].'" class=" view_detail fl">View Details</a>
													
												
													<a class="add_cart fr" href="voucher_template.php?user_id='.$user_id.'$booking_id='.$booking_id.'">View Voucher</a>
