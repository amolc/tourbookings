...
// alert()
	...
	var adult_oprice = $('#adult').val();
		var ad = '<?php echo $adult; ?>';
		var m = adult_oprice * hidden_price;
		var t ="USD $" + m ;
	// alert(m);
		 $('.total_price').text(t);
		 $('.total_price_c').val(t);
...
Tour/Activity Options</h6>
				...
				<!--<form action="update_to_cart.php">
                	<div class="left_penal mrgn_top background fl">
                        ...
                        <div class="update_option mrgn_top fl">
							...
							<!--<a href="#">
							<input class="submit_button" id="update_option" type="submit" value="Update Options"/>
						</a>
                        </div>
                    	</div>
                    	...
                    	<div class="tour_img fl"><img src="supplier/uploads/'.$obj['url'].'" alt="" width="155" height="139"> </div>
                        	...
                        	<div class="departs fl">
                            	<div class="departs_head fl">
								  ...
								  <div style="border-bottom: none;" class="select_travel_date fl">
									
									<div style="width:116px; float:left; margin-right:10px;">
										<label>Select Travel Date Departing</label>
										<input type="text" class="mySelectCalendar" id="datepicker3" value="'.$datepicker3.'" placeholder="mm/dd/yyyy"/>
										</div>
									</div>
							 <div style="margin-top: 141px;">
							 <div style="width:116px; float:left; margin-right:10px;">
								<label>Adult</label>
								<input type="text" style="width: 32px;text-align: center;" id="adult" value="'.$adult.'" name="adult"/>
							</div>
							<div style="width:116px; float:right; margin-top: -27px;">
								<label>Child</label>
								<input type="text" style="width: 32px;text-align: center;" value="'.$child.'" name="child"/>
							</div>
                        </div>
                                ...
                                <div class="price_guarantee fr">
                                	<p class="total_price">USD $'.$obj['price_per_person'] * $adult.'</p>
									<input type="hidden" id="hidden_price" value="'.$obj['price_per_person'].'"/>
									<input type="hidden" name="total_price" class="total_price_c" value=""/>
