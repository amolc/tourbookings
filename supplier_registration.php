...
$(document).ready(function(){
	...
	$( "#confirm_password" ).blur(function() {
		...
		// var email = $(this).val();
		// if(email.length < 4){$(".email_exit").html('');return;}
		
		// if(email.length >= 4){
			// $(".email_exit").html('alll');
			// $.post('ajax_request_function/ajax_check_email.php', {'email':email}, function(data) {
			  // $(".email_exit").append(data);
			// });
		// }
	// });	
...
<body>
	<div id="main_container">
    	<div class="header_main fl">
        	...
        	<div class="banner fl"><img src="images/partner_signup.jpg" alt="" width="1002" height="240"></div>
                	...
                	<div style="background:#fd8900;" class="left_penal fl">
                    	...
                    	<div class="right_penal fl">
                          ...
                          <div class="register_head fl">
                            	<h2>Register in our Travel Partner Program</h2><br>
                                <p>Simply fill out the form below and you will be eligible to join our Travel Partner Program. It is that simple!</p>
                               <p style="font-size: 15px;font-weight: bold;padding-top: 5px;">Note: Your email address will be your username for logging in to your account </p>
                            </div>
                            ...
                            <div class="administrator_details fl">
                                ...
                                <label> * Email:</label>
                                  <input name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$"  id="email" placeholder="" type="text" required>
                              ...
                              <div class="register_form fl">
                                ...
                                <select name="business_type" id="business_type">
                                  <option value="">Please select</option>
									...
									<option value="DESTINATION - ASIA">DESTINATION - ASIA</option>
									<option value="DESTINATION - AUSTRALIA/PACIFIC">DESTINATION - AUSTRALIA/PACIFIC</option>
									<option value="DESTINATION - EUROPE">DESTINATION - EUROPE</option>
									<option value="DESTINATION - NORTH AMERICA">DESTINATION - NORTH AMERICA</option>
									<option value="DESTINATION - SOUTH AMERICA">DESTINATION - SOUTH AMERICA</option>
									...
									<option value="TRAVEL PROVIDERS">TRAVEL PROVIDERS</option>
									<option value="VIATOR SUPPLIER">VIATOR SUPPLIER</option>
                                </select>
                                ...
                                <label>* Year Founded:</label>
                                  <input name="year_founded" id="year_founded" type="text">  
                                <label>* Staff:</label>
