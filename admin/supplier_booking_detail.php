...
<h2 style="float:left; width:85%;margin-bottom: 20px;">Confirm Booking</h2>
...
<br />
	...
	<?php
			...
			$result = mysql_query("SELECT
									...
									INNER JOIN traveler ON supplier.id = traveler.supplier_id AND tour.id = traveler.tour_id 
									AND Supplier_Booking.id = traveler.supplier_booking_id
									WHERE  Supplier_Booking.id = '".$booking_id."'
	...
	echo '
		<h3 style="float: right;">Total Price $'.$row['amount'].'</h3>
			<h3 style="float:left;">Booking Detail</h3>
				...
				echo '
						...
						<table class="table table-bordered datatable" id="table-1">
								<thead>
									...
									$result2 = mysql_query("SELECT * FROM traveler where supplier_booking_id = '".$row['id']."'");
