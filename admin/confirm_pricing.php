...
<table class="table table-bordered datatable" id="table-1">
	<thead>
		<tr>
			...
			<th>Price Adult</th>
			<th>Price Child</th>
			<th>Price Customer Adult</th>
			<th>Price Customer Child</th>
			<th>Price Partner Adult</th>
			<th>Price Partner Child</th>
			<th>Action</th>
		</tr>
	</thead>
	...
	echo'
		<tr class="odd gradeX">
			<td><a  style="" id="'.$row['tour_id'].'" class="fancybox" href="tour_detail.php?tour_id='.$row['tour_id'].'">'.$row['tour_id'].'</a></td>
			<td>'.$currency_name.'</td>
			...
			<td>
			<a  style="" href="upmark.php?tour_id='.$row['tour_id'].'" id="" class="">
